    ...
    <section class="admin-panel">
      ...
      <div class="admin-panel-header">
        ...
        <div>
          ...
          <p>
            Cập nhật màu sắc, size và mã SKU.
          </p>
      ...
      <div class="admin-form-body">
        ...
        <div class="admin-form-grid">
          ...
          <div class="admin-form-group">
            ...
            <input type="text" id="color" name="color" value="{{ old(
                                'color',
                                $variant->color
                            ) }}" maxlength="50" class="admin-form-control
                                @error('color')
                                    admin-input-error
                                @enderror" required>
          ...
          <div class="admin-form-group">
            ...
            <input type="text" id="size" name="size" value="{{ old(
                                'size',
                                $variant->size
                            ) }}" maxlength="30" class="admin-form-control
                                @error('size')
                                    admin-input-error
                                @enderror" required>
          ...
          <div class="admin-form-group admin-variant-sku-field">
            ...
            <input type="text" id="sku" name="sku" value="{{ old(
                                'sku',
                                $variant->sku
                            ) }}" maxlength="120" class="admin-form-control
                                @error('sku')
                                    admin-input-error
                                @enderror" required>
    ...
    <section class="admin-panel">
      ...
      <div class="admin-panel-header">
        ...
        <div>
          ...
          <p>
            Cập nhật tồn kho và chênh lệch giá của biến thể.
          </p>
