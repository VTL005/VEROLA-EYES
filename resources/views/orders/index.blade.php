...
<section class="section">
  ...
  <div class="velora-container">
    ...
    <div class="order-filter-tabs">
      ...
      <a href="{{ route('orders.index') }}" class="order-filter-tab {{ !$status ? 'active' : '' }}">
        Tất cả
      </a>
      ...
      <a href="{{ route(
                    'orders.index',
                    ['status' => 'delivered']
                ) }}" class="order-filter-tab {{ $status === 'delivered' ? 'active' : '' }}">
        Đã giao
      </a>
    ...
    <div class="customer-order-list">
      ...
      $firstReviewableDetail = null;

      if (
      $order->order_status
      === \App\Models\Order::STATUS_COMPLETED
      ) {
      $firstReviewableDetail =
      $order->details->first(
      ...
      <article class="customer-order-card">
        ...
        <a href="{{ route(
                                'orders.show',
                                $order
                            ) }}" class="customer-order-body customer-order-body-link"
        ...
        <div class="customer-order-footer order-card-actions">
          ...
          <form action="{{ route(
            ...
            onsubmit="return confirm('Bạn xác nhận đã nhận đầy đủ và kiểm tra đơn hàng?');">
          ...
          @elseif($order->details->isNotEmpty())
          ...
          <a href="{{ route(
                                        ...
                                        ) }}" class="btn btn-outline btn-sm order-complaint-button">
            Khiếu nại
          </a>
